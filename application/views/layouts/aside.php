        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">      
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-print"></i> <span>Usuario</span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                    ...
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-user-circle-o"></i> <span>Organizador</span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href="<?php echo base_url();?>Organizador/Eventos"><i class="fa fa-circle-o"></i> Eventos</a></li>
                            <li><a href="../../index.html"><i class="fa fa-circle-o"></i> Reportes</a></li>
                        </ul>
                    </li>
                </ul>
            </section>
